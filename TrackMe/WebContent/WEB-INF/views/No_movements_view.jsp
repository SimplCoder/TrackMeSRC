    ...
    <div id="wrapper">
       <div id="page-wrapper2" class="gray-bg">
            <div class="rowx wrapper border-bottom white-bg page-heading">
                <div class="col-sm-6">
                    <h2>No Movements View</h2>
                </div>
               <div class="col-sm-6">
                    <div class="text-right">
                        <a href="addNoMovements" target="frame1" style="width:160px" class="btn btn-primary">Add New Movement</a>
                    </div>
                </div>
            </div>
            <div class="row">
              ...
              columns:[
                       {data: "id",
                    	 "render": function ( data, type, full, meta ) {
                    	      return '<a href="EditMovementsView?id='+data+'"><i class="fa fa-pencil-square-o iconedit"  aria-hidden="true"></i></a>';}
                    	 },
                     {data: "id",
                        	 "render": function ( data, type, full, meta ) {
                       	      return '<a href="RemoveMovementsRecord?id='+data+'"><i class="fa fa-trash  icondelete" aria-hidden="true"></i></a>';}           	
