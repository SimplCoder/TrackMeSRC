...
<script type="text/javascript" src="https://cdn.datatables.net/buttons/1.2.4/js/buttons.colVis.min.js"></script>
  <script>
  var vehicleServiceJSON = ${vehicleServiceJSON};
		...
		$('#errorMessage').fadeOut(5000);
          ...
          $('#entrydata').DataTable({
              ...
              columns:[
                     ...
                     {data: "id",
                        	 "render": function ( data, type, full, meta ) {
                       	      return '<a href="RemoveVehicleServicesRecord?id='+data+'"><i class="fa fa-trash  icondelete" aria-hidden="true"></i></a>';}           	
                    		 
                     },
                       {data: "vehicleNo"},
                       {data: "driverMaster.driverName"},
                       {data:"serviceDateShow"},
